			...
			<c:forEach var="reply" items="${replylist}">
				<tr>
					...
					<td class="replybutton">
						<c:if test="${custId == reply.id}">
							<a href="javascript:replyEditForm(${reply.replynum}, ${reply.boardnum}, '${reply.text}')">
						[수정]</a>
						</c:if>
					</td>	
					<td class="replybutton">
						<c:if test="${custId == reply.id}">
							<a href="javascript:replyDelete(${reply.replynum}, ${reply.boardnum })">
						[삭제]</a>
						</c:if>
					</td>
				</tr>
